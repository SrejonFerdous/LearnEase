...
<i class="fas fa-envelope"></i>
    <label for="stumail" class="p1-2 font-weight-bold">Email</label><small id="statusMsg2"></small>
    <input type="email" class="form-control" name="stuemail" placeholder="Email" id="stuemail">
